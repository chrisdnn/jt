...
get_type_def = {'track':{'endpoint':'statuses/filter','method':'track'},
                ...
                'rate_limit_status':{'endpoint':'application/rate_limit_status', 'method':'resources'} }
...
def parse_args():
        ...
        parser.add_argument('-g','--get', choices=['track','history','rate_limit_status'], required=True)
