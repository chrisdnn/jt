...
def get_store_tweets(get_type, vkeywords, dtsince, dtuntil):
        ...
        try:
                ...
                for item in r.get_iterator():
                        if 'created_at' in item:
                                ...
                                #tweetsDAO.insert_data('tweets_test_exceptions',item, 0,'')
                                tweetsDAO.insert_data_no_duplicates('tweets_test_exceptions',item, 0,'')
                        else:
...
#for item in r:
        ...
        get_store_tweets(vargs['get'], vargs['keywords'] , vargs['since'], vargs['until'])
        '''
